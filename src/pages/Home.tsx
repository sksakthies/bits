...
const Home = () => {
  ...
  const glowCircle = (color: string, size: string, position: string, blur: string): React.ReactElement => (
    <div 
      className={`absolute ${position} w-${size} h-${size} rounded-full bg-${color} filter blur-${blur} opacity-30 animate-pulse`} 
  ...
  return (
    <div className="min-h-screen bg-dark-deeper">
      {/* Background Effects */}
      <div className="fixed inset-0 bg-dark-deeper overflow-hidden">
        {/* Gradient background */}
        <div className="absolute inset-0 bg-gradient-radial from-dark-deeper via-dark-lighter/5 to-dark-deeper" />
        
        {/* Animated dots pattern */}
        <div className="absolute inset-0 bg-[url('/grid.svg')] bg-center opacity-20" />
        
        {/* Glow effects */}
        {glowCircle('primary/20', '1/3', 'top-1/4 -left-1/6', '3xl')}
        {glowCircle('secondary/15', '1/4', 'bottom-10 right-0', '3xl')}
        <div className="absolute top-1/2 left-1/2 w-1/2 h-1/2 bg-primary/5 rounded-full filter blur-[150px] transform -translate-x-1/2 -translate-y-1/2" />
      </div>
      ...
      <div className="relative">
          ...
          <div ref={heroRef} className="max-w-7xl mx-auto">
            ...
            >
              ...
              <motion.div 
                ...
                className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full border border-primary/10 opacity-40"
              />
              <motion.div 
                initial={{ opacity: 0, rotate: 45 }}
                animate={{ opacity: 1, rotate: 0 }}
                transition={{ duration: 2 }}
                className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full border border-secondary/10 opacity-40"
              />
              ...
              <div className="flex flex-col items-center text-center">
                <motion.span 
                  ...
                  className="inline-block py-1 px-4 rounded-full bg-primary/10 border border-primary/20 text-sm font-medium text-white/80 mb-8"
                >
                ...
                >
                  ...
                  <br />
                  <span className="bg-gradient-to-r from-primary via-primary-light to-secondary text-transparent bg-clip-text inline-block mt-2">
                    Learning Journey
                  </span>
                </motion.h1>
                ...
                >
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-4 bg-white/5 backdrop-blur-md border border-white/10 rounded-lg font-medium 
                             text-white hover:bg-white/10 transition-all duration-300 flex items-center justify-center gap-2"
                  >
        ...
        {/* Features Section */}
        <section ref={featuresRef} className="relative py-24 px-6 sm:px-8 lg:px-10 bg-dark-deeper/80 backdrop-blur-md">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              <motion.h2 
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
                className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-primary to-secondary text-transparent bg-clip-text mb-4"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
              {[
                ...
                <motion.div
                  ...
                  className="relative p-8 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 
                           hover:border-primary/20 transition-all duration-500 group hover:shadow-lg hover:shadow-primary/5"
                >
                  {/* Glow effect on hover */}
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-primary to-secondary rounded-xl opacity-0 
                                group-hover:opacity-20 blur-sm transition-opacity duration-500" />
                  
                  {/* Content */}
                  <div className="relative">
                    <div className="w-14 h-14 flex items-center justify-center rounded-lg bg-primary/10 
                                 text-primary-light mb-6 group-hover:bg-primary/20 transition-colors duration-300">
                      {feature.icon}
                    </div>
                    ...
                    <div className="mt-6 flex items-center text-primary-light font-medium opacity-0 
